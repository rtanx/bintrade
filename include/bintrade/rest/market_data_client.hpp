...
public:
    ...
    [[nodiscard]] std::vector<models::Trade> get_recent_trades(const Symbol& symbol,
                                                               int limit = 500);
    [[nodiscard]] std::vector<models::Kline> get_klines(const Symbol& symbol,
                                                        std::string_view interval, int limit = 500);
